...
def render_berth_previews(
    ...
    gentle_bulged_points = [(96.0, 24.0), (108.0, 128.0), (120.0, 232.0)]
    gentle_bulged_water = _curved_shore_mask(gentle_bulged_points)
    gentle_bulged_segments = list(zip(gentle_bulged_points, gentle_bulged_points[1:]))
    bulged_points = [(96.0, 24.0), (118.0, 128.0), (120.0, 232.0)]
    bulged_water = _curved_shore_mask(bulged_points)
    bulged_segments = list(zip(bulged_points, bulged_points[1:]))
    ...
    outputs = {
        ...
        "gentle_bulged_alongside_cluster": _write_case(
            output_dir,
            "gentle_bulged_alongside_cluster",
            gentle_bulged_water,
            gentle_bulged_segments,
            berth_stern_prob=0.0,
            seed=18,
        ),
        "bulged_shore_stern_first_cluster": _write_case(
            output_dir,
            "bulged_shore_stern_first_cluster",
            bulged_water,
            bulged_segments,
            berth_stern_prob=0.0,
            seed=19,
