...
def main():
    ...
    slice_parser.add_argument("--min_bbox_size", type=float, default=None, help="Min bbox size in meters. Bboxes whose longer side (width or height) is less than this value are excluded. Default: disabled.")
